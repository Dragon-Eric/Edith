...
class BaiduVoiceApi:
    ...
    def __init__(self,appkey=os.getenv('APP_KEY', 'Ly0TST3N8Y7PA7pLrrou1PZX'),secretkey=os.getenv('SECRET_KEY', 'O4BphHmbRrwL4K7jBIdHD9cuzVMWAKmg')):
    ...
    def auth(self):
        ...
        if self.expire_time is None or monotonic() > self.expire_time:
            ...
            credential_url = "https://aip.baidubce.com/oauth/2.0/token?"
            ...
            response = self.session.post(credential_url, params=params)
